...
pnpm acceptance:full       68/68 checks — three demo adapters, the portal's
...
pnpm verify                509 unit + integration tests, typecheck, lint, build
...
```bash
pnpm verify           # typecheck, lint, 509 unit + integration tests, build
